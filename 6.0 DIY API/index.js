...
app.put ("/jokes/:id", (req, res)=>{
  ...
  const oldJoke = jokes.findIndex ((joke)=> joke.id===updateJoke.id);

  jokes [oldJoke] = updateJoke;
...
app.patch ("/jokes/:id", (req, res)=>{
  ...
  const replaceJoke ={
    id : id,
    jokeText : req.body.text || existingJoke.jokeText, // if req body text exists then joke text updates
